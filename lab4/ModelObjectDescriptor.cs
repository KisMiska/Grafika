...
namespace GrafikaSzeminarium
{
    internal class ModelObjectDescriptor:IDisposable
    {
        ...
        public unsafe static ModelObjectDescriptor CreateTeapot(GL GL)
        {
            float[] vertexArray;
            float[] colorArray;
            uint[] indexArray;

            ObjectResourceReader.CreateObjectFromResource(GL, "teapot.obj", out vertexArray, out colorArray, out indexArray);
